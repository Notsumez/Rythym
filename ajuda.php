...
<head>
    ...
    <title>RYTHYM - Ajuda</title>
</head>
<body>
    <noscript>Você precisa ativar o JavaScript para rodar essa aplicação.</noscript>
    <?php include('header.html');?>
    <div class="faq-pagina">
        <div class="faq-desktop-pagina">
            <h1 class="faq-titulo">
                <span>Como Podemos Ajudar?</span>
            </h1>
            <div class="faq-geral">
                <a class="faq-geral-item" href="" style="background-color: rgb(81, 173, 248);">
                    <div>
                        <div class="faq-geral-item-icon">
                            <span>

                            </span>
                        </div>
                    </div>
                    <h2 class="faq-geral-item-nome">Conta</h2>
                </a>
                <a class="faq-geral-item" href="" style="background-color: rgb(235, 95, 44);">
                    <div>
                        <div class="faq-geral-item-icon">
                            <span>
                    ...
                    <h2 class="faq-geral-item-nome">Planos Premium</h2>
                </a>
                <a class="faq-geral-item" href="" style="background-color: rgb(129, 69, 131);">
                    <div>
                        <div class="faq-geral-item-icon">
                            <span>
                    ...
                    <h2 class="faq-geral-item-nome">Pagamento</h2>
                </a>
                <a class="faq-geral-item" href="" style="background-color: rgb(159, 36, 245);">
                    <div>
                        <div class="faq-geral-item-icon">
                            <span>
                    ...
                    <h2 class="faq-geral-item-nome">Reprodução de Música</h2>
                </a>
                <a class="faq-geral-item" href="" style="background-color: rgb(255, 155, 182);">
                    <div>
                        <div class="faq-geral-item-icon">
                            <span>
                    ...
                    <h2 class="faq-geral-item-nome">Recursos</h2>
                </a>
                <a class="faq-geral-item" href="" style="background-color: rgb(255, 151, 5);">
                    <div>
                        <div class="faq-geral-item-icon">
                            <span>
                    ...
                    <h2 class="faq-geral-item-nome">Conteúdo Musical</h2>
                </a>
                <a class="faq-geral-item" href="" style="background-color: rgb(191, 193, 58);">
                    <div>
                        <div class="faq-geral-item-icon">
                            <span>
                    ...
                    <h2 class="faq-geral-item-nome">Artistas/Criadores</h2>
                </a>
                <a class="faq-geral-item" href="" style="background-color: rgb(42, 97, 242);">
                    <div>
                        <div class="faq-geral-item-icon">
                            <span>
                    ...
                    <div class="faq-sub-perguntas-lista">
                        <div class="faq-sub-perguntas-lista-item">
                            ...
                            <div class="faq-sub-perguntas-lista-item-desc" style="display: none;">
                                ...
                                parte inferior da sua página "Eu" e verificar os planos Premium que preparamos para você. Tentamos 
                        ...
                        <div class="faq-sub-perguntas-lista-item">
                            ...
                            <div class="faq-sub-perguntas-lista-item-desc" style="display: none;">
                                ...
                                <strong>• Para usuários que já tiveram Premium anteriormente:</strong>
                                50% de desconto mensal durante os 3 primeiros meses, e ao fim desse período, o plano será renovado automaticamente pelo valor integral de R$16,90. Promoção válida apenas para usuários Android. <br><br>

                                <strong>• Para usuários que utilizaram apenas o período gratuito anteriormente:</strong>
                                80% de desconto mensal no primeiro mês, e ao fim desse período, o plano será renovado automaticamente pelo valor integral de R$16,90. Promoção válida apenas para usuários Android <br><br>

                                <strong>Note que:</strong> <br>
